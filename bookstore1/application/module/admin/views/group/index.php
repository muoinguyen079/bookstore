...
<?php   include_once (MODULE_PATH . 'admin/views/toolbar.php') ;
    ...
    $selectboxGroupACP    = Helper::cmsSelectbox('filter_group_acp','inputbox',$arrGroupACP,isset($this->arrParam['filter_group_acp']) ? $this->arrParam['filter_group_acp'] : null,null ,'filter_group_acp' );
